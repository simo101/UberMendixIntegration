...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(googlemaps.actions.CalculateGeo.class);
			...
			component.actionRegistry().registerUserAction(oauthmodule.actions.JA_SiginCallBackRH.class);
			component.actionRegistry().registerUserAction(oauthmodule.actions.JA_SiginRH.class);
